...
def api_methods():
    methods_info = {
        ...
        'preprocess': 'Preprocess the uploaded data',
        'datasets': 'Get list of available datasets',
        'select_dataset': 'Select a dataset for further operations',
        'models': 'Get list of available models',
        'select_model': 'Select a model for predictions',
        'predict': 'Make predictions using the selected model',
        'plot': 'Generate a plot of predictions',
        'methods': 'Get information about API methods',
        'version': 'Get information about API version and author'
    }
    return jsonify(methods_info)
